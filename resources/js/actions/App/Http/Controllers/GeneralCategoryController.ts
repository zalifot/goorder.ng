...
/**
* @see \App\Http\Controllers\GeneralCategoryController::index
...
const GeneralCategoryController = { index, store, update, toggleStatus, destroy }

export default GeneralCategoryController