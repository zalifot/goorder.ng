 ...
 * @see app/Http/Controllers/ShopController.php:470
 * @route '/vendor/orders'
 */
 ...
 * @see app/Http/Controllers/ShopController.php:506
 ...
 * @see app/Http/Controllers/ShopController.php:57
 * @route '/vendor/shops'
 */
 ...
 * @see app/Http/Controllers/ShopController.php:85
 ...
 * @see app/Http/Controllers/ShopController.php:256
 ...
 * @see app/Http/Controllers/ShopController.php:364
...
/**
* @see \App\Http\Controllers\ShopController::updateOrderStatus
 * @see app/Http/Controllers/ShopController.php:404
 * @route '/vendor/manage/shop/{publicId}/orders/{order}/status'
 */
export const updateOrderStatus = (args: { publicId: string | number, order: number | { id: number } } | [publicId: string | number, order: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/vendor/manage/shop/{publicId}/orders/{order}/status'
 */
updateOrderStatus.url = (args: { publicId: string | number, order: number | { id: number } } | [publicId: string | number, order: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    publicId: args[0],
                    order: args[1],
 ...
 * @route '/vendor/manage/shop/{publicId}/orders/{order}/status'
 */
updateOrderStatus.patch = (args: { publicId: string | number, order: number | { id: number } } | [publicId: string | number, order: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updateOrderStatus.url(args, options),
    method: 'patch',
})
 ...
 * @route '/vendor/manage/shop/{publicId}/orders/{order}/status'
 */
    const updateOrderStatusForm = (args: { publicId: string | number, order: number | { id: number } } | [publicId: string | number, order: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/vendor/manage/shop/{publicId}/orders/{order}/status'
 */
        updateOrderStatusForm.patch = (args: { publicId: string | number, order: number | { id: number } } | [publicId: string | number, order: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updateOrderStatus.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @see app/Http/Controllers/ShopController.php:437
 ...
 * @see app/Http/Controllers/ShopController.php:166
 ...
 * @see app/Http/Controllers/ShopController.php:230
 ...
 * @see app/Http/Controllers/ShopController.php:243
 ...
 * @see app/Http/Controllers/ShopController.php:216
 * @route '/vendor/shops/{shop}'
 */
...
const ShopController = { allOrders, allTransactions, index, show, analytics, shopOrders, updateOrderStatus, shopTransactions, store, update, toggleActive, toggleConstruction, destroy }
