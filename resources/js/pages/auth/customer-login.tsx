        ...
        >
            ...
            <form onSubmit={submit} className="flex flex-col gap-5">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            {canResetPassword && (
                                <Link
                                    ...
                                    className="text-sm font-medium text-blue-600 transition hover:text-blue-700 dark:text-blue-500"
                                    tabIndex={5}
                                >
                                    Forgot password?
                                </Link>
                ...
                <div className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <Link href="/customer-register" className="font-medium text-blue-600 transition hover:text-blue-700 dark:text-blue-500" tabIndex={6}>
                        Create one
                    </Link>
                </div>
