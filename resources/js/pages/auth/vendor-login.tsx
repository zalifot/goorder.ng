    ...
    return (
        ...
        >
            ...
            <form onSubmit={submit} className="flex flex-col gap-5">
                <div className="grid gap-5">
                    ...
                    <div className="grid gap-2">
                        <div className="flex items-center justify-between">
                            ...
                            {canResetPassword && (
                                <Link
                                    ...
                                    className="text-sm font-medium text-emerald-600 transition hover:text-emerald-700 dark:text-emerald-500"
                                    tabIndex={5}
                                >
                                    Forgot password?
                                </Link>
                        ...
                        <div className="relative">
                            <Input
                                ...
                                className="h-12 rounded-xl border-gray-300 bg-gray-50 px-4 pr-12 transition focus:border-emerald-500 focus:bg-white focus:ring-emerald-500 dark:border-gray-700 dark:bg-gray-800 dark:focus:border-emerald-500"
                            />
                            <button
                                type="button"
                    ...
                    <div className="flex items-center gap-3">
                        <Checkbox
                            ...
                            tabIndex={3}
                            className="h-5 w-5 rounded-md border-gray-300 data-[state=checked]:bg-emerald-600 data-[state=checked]:border-emerald-600"
                        />
                    ...
                    <Button
                        type="submit"
                        className="mt-2 h-12 w-full rounded-xl bg-emerald-600 text-base font-medium transition hover:bg-emerald-700"
                        tabIndex={4}
                        disabled={processing}
                    >
                        {processing ? (
                ...
                {/* Google Sign In */}
                <a
                    href="/auth/google?role=shop_owner"
                ...
                <div className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <Link href="/vendor-register" className="font-medium text-emerald-600 transition hover:text-emerald-700 dark:text-emerald-500" tabIndex={6}>
                        Become a vendor
                    </Link>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 dark:text-gray-400">
                    Are you a customer?{' '}
                    <Link href="/customer-login" className="font-medium text-blue-600 transition hover:text-blue-700" tabIndex={7}>
                        Customer login
                    </Link>
                </div>
            </form>
