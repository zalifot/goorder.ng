...
export default function VendorRegister() {
    ...
    return (
        <AuthAppleLayout
            ...
            description="Create your vendor account and launch your store"
            variant="vendor"
        >
            ...
            <form onSubmit={submit} className="flex flex-col gap-5">
                ...
                <div className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <Link href="/vendor-login" className="font-medium text-emerald-600 transition hover:text-emerald-700 dark:text-emerald-500" tabIndex={6}>
                        Sign in
                    </Link>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 dark:text-gray-400">
                    Just want to shop?{' '}
                    <Link href="/register" className="font-medium text-blue-600 transition hover:text-blue-700" tabIndex={7}>
