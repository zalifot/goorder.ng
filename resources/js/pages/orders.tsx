...
import { BadgeCheck, Clock, Package, ShoppingCart, Store, TrendingUp } from 'lucide-react';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground">Orders from all your shops in one place.</p>
                </div>
                        ...
                        <CardContent className="px-4 pb-4">
                            <div className="space-y-0">
                                {orders.map((order, index) => (
                                    <div key={order.id}>
                                        <div className="flex items-center gap-3 py-3 hover:bg-accent/30 -mx-2 px-2 rounded-lg transition-colors">
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="text-xs text-muted-foreground">
                                                    {order.shop ? (
                                                        <Link href={`/vendor/manage/shop/${order.shop.public_id}`} className="hover:underline">
                                                            {order.shop.name}
                                                        </Link>
                                                    ) : '—'} · {formatDate(order.created_at)} · <span className="capitalize">{order.delivery_type}</span>
                                                </p>
                                            </div>
