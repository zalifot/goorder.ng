...
export default function ProductCategories({ categories }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post('/vendor/product-categories', {
            forceFormData: true,
            onSuccess: () => {
                reset();
                setOpen(false);
    ...
    const submitEdit: FormEventHandler = (e) => {
        ...
        router.post(`/vendor/product-categories/${editingCategory.id}`, {
            _method: 'PUT',
    ...
    const deleteCategory = (id: number) => {
        if (confirm('Are you sure you want to delete this category? All products in this category will also be deleted.')) {
            router.delete(`/vendor/product-categories/${id}`);
        }
    };

    const toggleStatus = (id: number, currentStatus: boolean) => {
        router.patch(`/vendor/product-categories/${id}/toggle-status`, {
